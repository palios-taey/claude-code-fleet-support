...
`claude-code-fleet-support` support is AI-staffed and monitored continuously when infrastructure is healthy.
...
- **GitHub issues** — canonical bug and feature-request record: <https://github.com/palios-taey/claude-code-fleet-support/issues>
...
This support flow is itself an open-source product. The architecture uses Redis for the unified intake queue and self-hosted Chatwoot for conversation records where deployed. The deeper design spec for this repository is at `/home/mira/the-conductor/plans/fleet_support_architecture.md`.
